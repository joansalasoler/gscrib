...
import serial
from gscrib import printrun
from gscrib.printrun import eventhandler
...
def mock_socket(test, read_function=slow_printer):
    ...
    # First mock the selector and its methods
    selector_mock = mock.create_autospec(selectors.DefaultSelector)
